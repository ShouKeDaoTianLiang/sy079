...
public class CashGUI extends JFrame
{
    ...
    public CashGUI() {
        ...
        this.setTitle("岁月商城控制台 当前版本：v079");
        this.initComponents();
    ...
    private void initComponents() {
        ...
        this.喜庆物品.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                CashGUI.this.喜庆物品ActionPerformed(evt);
            }
        });
        ...
        this.喜庆物品1.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                CashGUI.this.喜庆物品1ActionPerformed(evt);
            }
        });
        ...
        this.jTabbedPane1.getAccessibleContext().setAccessibleName("数据库商城设置");
    ...
    private void jButton26ActionPerformed(final ActionEvent evt) {
        if (this.jTextField11.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "请填写ID", "错误", 0);
        }
        else {
    ...
    private void jButton1ActionPerformed(final ActionEvent evt) {
        this.initCharacterPannel();
        JOptionPane.showMessageDialog(null, "正在刷新时间很久哦。");
    }
