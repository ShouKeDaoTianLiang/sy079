...
public class MapleReactorFactory
{
    ...
    public static final MapleReactorStats getReactor(final int rid) {
        MapleReactorStats stats = (server.maps.MapleReactorStats)(server.maps.MapleReactorStats)MapleReactorFactory.reactorStats.get(rid);
        if (stats == null) {
            int infoId = rid;
            ...
            if (link != null) {
                ...
                stats = (server.maps.MapleReactorStats)(server.maps.MapleReactorStats)MapleReactorFactory.reactorStats.get(infoId);
            }
            if (stats == null) {
