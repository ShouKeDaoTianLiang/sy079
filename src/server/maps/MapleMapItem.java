...
public class MapleMapItem extends AbstractMapleMapObject
{
    ...
    public MapleMapItem(final Item item, final Point position, final MapleMapObject dropper, final MapleCharacter owner, final byte type, final boolean playerDrop) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public MapleMapItem(final Item item, final Point position, final MapleMapObject dropper, final MapleCharacter owner, final byte type, final boolean playerDrop, final int questid) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public MapleMapItem(final Point position, final Item item) {
        this.meso = 0;
        this.questid = -1;
        this.pickedUp = false;
        this.randDrop = false;
    ...
    public void setItem(final Item z) {
        this.item = z;
    }
    ...
    public void sendSpawnData(final MapleClient client) {
        if (this.questid <= 0 || client.getPlayer().getQuestStatus(this.questid) == 1) {
            client.getSession().write(MaplePacketCreator.dropItemFromMapObject(this, null, this.getPosition(), (byte)2));
        }
    }
    
    @Override
    public void sendDestroyData(final MapleClient client) {
        client.getSession().write(MaplePacketCreator.removeItemFromMap(this.getObjectId(), 1, 0));
    }
