...
public class MapleMonster extends AbstractLoadedMapleLife
{
                    ...
                    for (final AttackerEntry mattacker : this.attackers) {
                        for (final AttackingMapleCharacter cattacker : mattacker.getAttackers()) {
                            if (cattacker != null && cattacker.getAttacker().getMap() == from.getMap() && cattacker.getLastAttackTime() >= System.currentTimeMillis() - 4000L) {
                                cattacker.getAttacker().getClient().sendPacket(MobPacket.showMonsterHP(this.getObjectId(), (int)Math.ceil(this.hp * 100.0 / this.getMobMaxHp())));
                            }
                        }
                    }
                }
                        ...
                        case 3: {
                            for (final AttackerEntry mattacker2 : this.attackers) {
                                for (final AttackingMapleCharacter cattacker2 : mattacker2.getAttackers()) {
                                    if (cattacker2 != null && cattacker2.getAttacker().getMap() == from.getMap() && cattacker2.getLastAttackTime() >= System.currentTimeMillis() - 4000L) {
                                        cattacker2.getAttacker().getClient().sendPacket(MobPacket.showMonsterHP(this.getObjectId(), (int)Math.ceil(this.hp * 100.0 / this.getMobMaxHp())));
                                    }
                                }
                            }
                            break;
    ...
    private void giveExpToCharacter(final MapleCharacter attacker, int exp, final boolean highestDamage, final int numExpSharers, final byte pty, final byte Class_Bonus_EXP_PERCENT, final byte Premium_Bonus_EXP_PERCENT, final int lastskillID) {
        ...
        if (exp > 0) {
            final MonsterStatusEffect mse = (client.status.MonsterStatusEffect)(client.status.MonsterStatusEffect)this.stati.get(MonsterStatus.SHOWDOWN);
            if (mse != null) {
            ...
            final Integer 神圣祈祷 = attacker.getBuffedValue(MapleBuffStat.HOLY_SYMBOL);
            if (神圣祈祷 != null) {
                if (numExpSharers == 1) {
                    exp *= (int)(1.0 + 神圣祈祷 / 500.0);
                }
                else {
                    exp *= (int)(1.0 + 神圣祈祷 / 100.0);
                }
            }
    ...
    public final int killBy(final MapleCharacter killer, final int lastSkill) {
        final long totalBaseExp = this.getMobExp();
        ...
        for (final AttackerEntry attackEntry : this.attackers) {
            final int baseExp = (int)Math.ceil(totalBaseExp * (attackEntry.getDamage() / (double)this.getMobMaxHp()));
        ...
        EtcTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                if (c.getPlayer() != null) {
                    ...
                    if (map.getCharactersThreadsafe().size() > 1) {
    ...
    public final void sendSpawnData(final MapleClient client) {
        ...
        client.getSession().write(MobPacket.spawnMonster(this, (this.lastNode >= 0) ? -2 : -1, this.fake ? 252 : ((this.lastNode >= 0) ? 12 : 0), 0));
    ...
    public String toString() {
        ...
        sb.append("蓝量,");
        sb.append("/");
        sb.append(this.stats.getPhysicalDefense());
        sb.append("防御, oid: ");
    ...
    public final int getStatusSourceID(final MonsterStatus status) {
        final MonsterStatusEffect effect = (client.status.MonsterStatusEffect)(client.status.MonsterStatusEffect)this.stati.get(status);
        if (effect != null) {
    ...
    public final ElementalEffectiveness getEffectiveness(final Element e) {
        if (this.stati.size() > 0 && this.stati.get(MonsterStatus.封印) != null) {
    ...
    public final void applyStatus(final MapleCharacter from, final MonsterStatusEffect status, final boolean poison, final long duration, final boolean venom, final boolean checkboss) {
        ...
        if (from.isGM()) {
            from.dropMessage(6, "怪物: " + this.getId() + " 状态: " + status.getStati().name() + " 持续时间: " + duration);
        }
        ...
        if (this.stats.isNoDoom() && stat == MonsterStatus.封印) {
            return;
        }
        ...
        final MonsterStatusEffect oldEffect = (client.status.MonsterStatusEffect)(client.status.MonsterStatusEffect)this.stati.get(stat);
        if (oldEffect != null) {
            ...
            for (final MonsterDropEntry d : dropEntry) {
                if (d.itemId > 0 && d.questid == 0 && d.itemId / 10000 != 238 && Randomizer.nextInt(999999) < (int)(10 * d.chance * chServerrate * chr.getDropMod() * (chr.getStat().dropBuff / 100.0) * (showdown / 100.0))) {
                    ...
                    if (GameConstants.getInventoryType(d.itemId) == MapleInventoryType.EQUIP) {
                        ...
                        idrop = new Item(d.itemId, (byte)0, (short)0);
                    }
    ...
    public final void cancelStatus(final MonsterStatus stat) {
        final MonsterStatusEffect mse = (client.status.MonsterStatusEffect)(client.status.MonsterStatusEffect)this.stati.get(stat);
        ...
        if (this.getController() != null && !this.getController().isMapObjectVisible(this)) {
            this.getController().getClient().getSession().write(MobPacket.cancelMonsterStatus(this.getObjectId(), stat));
        }
        this.stati.remove(stat);
    ...
    public final void startDropItemSchedule() {
        ...
        this.shouldDropItem = false;
        this.dropItemSchedule = MobTimer.getInstance().register(new Runnable() {
            @Override
            public void run() {
                if (MapleMonster.this.isAlive() && map != null) {
                    if (shouldDropItem) {
                        map.spawnAutoDrop(itemId, MapleMonster.this.getPosition());
                    }
                    else {
                        shouldDropItem = true;
                    }
    ...
    public void setMoveLocked(final boolean b) {
        this.moveLock = b;
    }
    ...
    public boolean getBelongsToSomeone() {
        return this.belongsTo != -1 && this.endBelong > System.currentTimeMillis();
    }
    ...
    public long getBelongTimeLeft() {
        if (this.getBelongsToSomeone()) {
            return this.endBelong - System.currentTimeMillis();
        }
        return 0L;
    }
    ...
    public boolean isBoss() {
        return this.stats.isBoss();
    }
    
    public void setBelongsTo(final MapleCharacter chr) {
        if (this.belongsTo != -1) {
            return;
        }
        if (this.isBoss()) {
        ...
        this.endBelong = System.currentTimeMillis() + 30000L;
    }
    ...
    public void setBelongTo(final MapleCharacter chr) {
        this.belongsTo = chr.getId();
    }
