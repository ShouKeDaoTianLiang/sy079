...
public class MobAttackInfoFactory
{
    ...
    public MobAttackInfo getMobAttackInfo(final MapleMonster mob, final int attack) {
        MobAttackInfo ret = (server.life.MobAttackInfo)(server.life.MobAttackInfo)MobAttackInfoFactory.mobAttacks.get(new Pair(mob.getId(), attack));
        if (ret != null) {
            return ret;
        }
    ...
    static {
        ...
        mobAttacks = new WeakHashMap<Pair<Integer, Integer>, MobAttackInfo>();
    }
}
