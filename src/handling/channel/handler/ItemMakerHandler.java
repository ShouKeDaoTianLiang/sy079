        ...
        switch (makerType) {
            case 1: {
                ...
                if (GameConstants.isGem(toCreate)) {
                    ...
                    MapleInventoryManipulator.addById(c, randGemGiven, (short)((taken == randGemGiven) ? 9 : 1), (byte)0);
            ...
            case 4: {
                ...
                if (!ii2.isDropRestricted(itemId) && !ii2.isAccountShared(itemId)) {
                    ...
                    MapleInventoryManipulator.addById(c, toGive2[0], (short)toGive2[1], (byte)0);
