...
{
    public static final List<LifeMovementFragment> parseMovement(final SeekableLittleEndianAccessor lea, final int kind, final MapleCharacter chr) {
        ...
        while (i < numCommands) {
            ...
            System.out.println("移动类型: " + 类型 + ", 剩下的 : " + (numCommands - res.size()) + " 移动类型属于 ID: " + command + ", 封包 : " + lea.toString(true));
            return null;
        }
        return res;
    }
