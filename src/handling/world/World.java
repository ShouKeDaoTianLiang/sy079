...
public class World
{
    ...
    public static void registerRespawn() {
        WorldTimer.getInstance().register(new Respawn(), Integer.parseInt(ServerProperties.getProperty("channel.怪物重生时间")) * 1000);
    }
    ...
    public static void handleMap(final MapleMap map, final int numTimes, final int size) {
        ...
        final int 时间 = Integer.parseInt(ServerProperties.getProperty("world.清理怪物时间"));
        if (map.playerCount() == 0) {
            if (numTimes % 时间 == 0 && map.getMobsSize() > 0) {
                FileoutputUtil.logToFile("日志/定时清怪记录/" + map.getMapName() + ".log", FileoutputUtil.NowTime() + " 地图[" + map.getMapName() + "][" + map.getId() + "]清理[" + map.getMobsSize() + "]了个怪物。\r\n");
    ...
    public static class Client
    {
        ...
        private static final Map<Integer, MapleClient> clients1;
        ...
        public static void addClient(final Integer accountId, final MapleClient c) {
            Client.lock.readLock().lock();
            try {
                if (!Client.clients1.containsKey(accountId)) {
                    Client.lock.readLock().unlock();
                    Client.lock.writeLock().lock();
                    try {
                        Client.clients1.put(accountId, c);
                    }
                    finally {
                        Client.lock.readLock().lock();
        ...
        public static MapleClient getClient(final Integer accountId) {
            MapleClient ret = null;
            Client.lock.readLock().lock();
            try {
                ret = (client.MapleClient)(client.MapleClient)Client.clients1.get(accountId);
            }
            finally {
                Client.lock.readLock().unlock();
            }
        ...
        static {
            ...
            clients1 = new HashMap<Integer, MapleClient>();
    ...
    public static class Party
    {
        ...
        public static void partyChat(final int partyid, final String chattext, final String namefrom) {
            ...
            for (final MaplePartyCharacter partychar : party.getMembers()) {
                ...
                FileoutputUtil1.玩家谈话("" + partychar.getName() + "组队聊天.txt", "玩家: " + partychar.getName() + " 在组队中说: " + chattext + " \r\n时间：" + FileoutputUtil.CurrentReadable_Time() + "");
            }
        }
            ...
            for (final int characterId : recipientCharacterIds) {
                ...
                if (ch > 0) {
                    ...
                    if (chr != null && chr.getBuddylist().containsVisible(cidFrom)) {
                        ...
                        FileoutputUtil1.玩家谈话("" + chr.getName() + "好友聊天.txt", "玩家: " + characterId + " 在好友中说: " + chattext + "\r\n时间：" + FileoutputUtil.CurrentReadable_Time() + "");
                    }
                }
            }
        }
    ...
    public static class Guild
    {
        ...
        public static MapleGuild getGuild(final int id) {
            ...
            try {
                ret = (handling.world.guild.MapleGuild)(handling.world.guild.MapleGuild)Guild.guilds.get(id);
            }
            finally {
    ...
    public static class Find
    {
        ...
        public static int findChannel(final int id) {
            ...
            Integer ret;
            try {
                ret = (Integer)(Integer)Find.idToChannel.get(id);
            }
            finally {
        ...
        public static int findChannel(final String st) {
            ...
            Integer ret;
            try {
                ret = (Integer)(Integer)Find.nameToChannel.get(st.toLowerCase());
            }
            finally {
                Find.lock.readLock().unlock();
            }
    ...
    public static class Alliance
    {
        ...
        public static MapleGuildAlliance getAlliance(final int allianceid) {
            ...
            try {
                ret = (handling.world.guild.MapleGuildAlliance)(handling.world.guild.MapleGuildAlliance)Alliance.alliances.get(allianceid);
            }
            finally {
    ...
    public static class Family
    {
        ...
        public static MapleFamily getFamily(final int id) {
            ...
            try {
                ret = (handling.world.family.MapleFamily)(handling.world.family.MapleFamily)Family.families.get(id);
            }
            finally {
