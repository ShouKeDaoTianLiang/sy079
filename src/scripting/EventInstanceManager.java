...
public class EventInstanceManager
{
    ...
    public EventInstanceManager(final EventManager em, final String name, final int channel) {
        ...
        this.killCount = new WeakHashMap<Integer, Integer>();
    ...
    public void registerPlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : playerEntry:\n" + ex2);
        }
    }
    ...
    public void changedMap(final MapleCharacter chr, final int mapid) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "副本名称" + this.em.getName() + ", 实例名称 : " + this.name + ", 方法名称 : changedMap:\n" + ex);
        }
    }
        ...
        this.eventTimer = EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + em.getName() + ", Instance name : " + name + ", method Name : scheduledTimeout:\n" + ex);
    ...
    public boolean isSquadLeader(final MapleCharacter tt, final MapleSquadType ttt) {
    ...
    public void unregisterMonster(final MapleMonster mob) {
        ...
        if (this.mobs.isEmpty()) {
            try {
                ...
                FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : allMonstersDead:\n" + ex);
    ...
    public void playerKilled(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : playerDead:\n" + ex);
    ...
    public boolean revivePlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : playerRevive:\n" + ex);
    ...
    public void playerDisconnected(final MapleCharacter chr, final int idz) {
        ...
        byte ret;
        try {
            ret = ((Number)this.em.getIv().invokeFunction("playerDisconnected", this, chr)).byteValue();
        }
        catch (Exception e) {
            ret = 0;
        }
    ...
    public void monsterKilled(final MapleCharacter chr, final MapleMonster mob) {
        ...
        try {
            Integer kc = (Integer)(Integer)this.killCount.get(chr.getId());
            final int inc = ((Number)this.em.getIv().invokeFunction("monsterValue", this, mob.getId())).intValue();
            if (this.disposed) {
                return;
            }
            if (kc == null) {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.txt", "Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name + ", method Name : monsterValue:\n" + ex);
        }
            ...
            ex3.printStackTrace();
            FileoutputUtil.outputFileError("日志/Logs/Log_Script_脚本异常.txt", ex3);
        }
    }
    ...
    public void monsterDamaged(final MapleCharacter chr, final MapleMonster mob, final int damage) {
        ...
        try {
            ...
            System.out.println("Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name + ", method Name : monsterValue:\n" + ex);
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name + ", method Name : monsterValue:\n" + ex);
        }
        catch (NoSuchMethodException ex2) {
            System.out.println("Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name + ", method Name : monsterValue:\n" + ex2);
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + ((this.em == null) ? "null" : this.em.getName()) + ", Instance name : " + this.name + ", method Name : monsterValue:\n" + ex2);
            ...
            ex3.printStackTrace();
            FileoutputUtil.outputFileError("日志/Logs/Log_Script_脚本异常.rtf", ex3);
        }
    }
    ...
    public int getKillCount(final MapleCharacter chr) {
        ...
        final Integer kc = (Integer)(Integer)this.killCount.get(chr.getId());
        if (kc == null) {
            return 0;
        }
        return kc;
    ...
    public void dispose_NoLock() {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + emN + ", Instance name : " + this.name + ", method Name : dispose:\n" + e);
        }
    }
    ...
    public final MapleMap getMapInstance(final int args) {
        ...
        try {
            ...
            if (args >= this.mapIds.size()) {
                ...
                trueMapID = (Integer)(Integer)this.mapIds.get(args);
                instanced = (Boolean)(Boolean)this.isInstanced.get(args);
            }
            MapleMap map = null;
            if (!instanced) {
        ...
        EventTimer.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + em.getName() + ", Instance name : " + name + ", method Name(schedule) : " + methodName + " :\n" + ex);
                }
            }
        }, delay);
    }
    ...
    public final void leftParty(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : leftParty:\n" + ex);
        }
    }
    ...
    public final void disbandParty() {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : disbandParty:\n" + ex);
        }
    }
    ...
    public final void finishPQ() {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : clearPQ:\n" + ex);
        }
    }
    ...
    public final void removePlayer(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : playerExit:\n" + ex);
        }
    }
    ...
    public final void registerCarnivalParty(final MapleCharacter leader, final MapleMap map, final byte team) {
        ...
        final List characters = new LinkedList();
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : registerCarnivalParty:\n" + ex);
        }
        catch (NoSuchMethodException ex2) {}
    }
    ...
    public void onMapLoad(final MapleCharacter chr) {
        ...
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Event name" + this.em.getName() + ", Instance name : " + this.name + ", method Name : onMapLoad:\n" + ex);
        }
        catch (NoSuchMethodException ex2) {}
    }
    ...
    public boolean check() {
        for (final MapleCharacter chr : this.getPlayers()) {
            if (chr.getLevel() < 30 || chr.getLevel() > 70) {
                return false;
            }
        }
        return true;
