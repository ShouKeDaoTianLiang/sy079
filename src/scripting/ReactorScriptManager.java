...
public class ReactorScriptManager extends AbstractScriptManager
{
    ...
    public final void act(final MapleClient c, final MapleReactor reactor) {
        try {
            ...
            FileoutputUtil.log("日志/Logs/Log_Script_脚本异常.rtf", "Error executing reactor script. ReactorID: " + reactor.getReactorId() + ", ReactorName: " + reactor.getName() + ":" + e);
        }
    }
    
    public final List<ReactorDropEntry> getDrops(final int rid) {
        List<ReactorDropEntry> ret = (java.util.List)(java.util.List)this.drops.get(rid);
        if (ret != null) {
            return ret;
        }
