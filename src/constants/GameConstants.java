...
public class GameConstants
{
    ...
    public static final int 监狱地图 = 910000000;
    ...
    public static final int[] 自动掉落物品;
    public static int[] owlItems;
    public static final int[] 黑龙箱子;
    public static final List<Balloon> lBalloon;
    ...
    public static boolean is经验卡(final int itemId) {
        switch (itemId) {
            case 5210000:
            case 5210001:
            case 5210003:
    ...
    public static boolean is战士(final int job) {
        return (job >= 100 && job <= 132) || (job >= 1100 && job <= 1111);
    }
    
    public static boolean is法师(final int job) {
        return (job >= 200 && job <= 232) || (job >= 1200 && job <= 1211);
    }
    
    public static boolean is飞侠(final int job) {
        return (job >= 400 && job <= 422) || (job >= 1400 && job <= 1411);
    }
    
    public static boolean is弓手(final int job) {
        return (job >= 300 && job <= 322) || (job >= 1300 && job <= 1311);
    }
    
    public static boolean is海盗(final int job) {
        return (job >= 500 && job <= 522) || (job >= 1500 && job <= 1511);
    }
    
    public static boolean is骑士团(final int job) {
        return job >= 1000 && job <= 1611;
    }
    ...
    public static int getExpRate_Below11(final int job) {
        if (isAdventurer1(job)) {
            return 2;
        }
        if (isAdventurer1(job) || isAdventurer1(job)) {
            return 2;
        }
        return 2;
    }
    
    public static boolean isAdventurer1(final int job) {
        return job >= 0 && job < 3000;
    }
    ...
    public static int getExpRate_任务经验(final int level) {
        return 2;
    }
    ...
    public static boolean 稀有物品(final int itemId) {
        switch (itemId) {
            case 1002357:
            case 2340000: {
                return true;
    ...
    public static List<Balloon> getBalloons() {
        if (GameConstants.lBalloon.isEmpty()) {
            GameConstants.lBalloon.add(new Balloon(ServerProperties.getProperty("world.登陆气泡"), 236, 122));
            GameConstants.lBalloon.add(new Balloon("岁月工作室版本定制:947039454 ", 396, 276));
        }
        return GameConstants.lBalloon;
    }
    
    public static boolean is武陵道场(final int mapId) {
    ...
    static {
        ...
        GameConstants.fishingReward = new int[] { 0, 90, 1, 70, 4031627, 2, 4031628, 1, 4031630, 1, 4031631, 1, 4031632, 1, 4031633, 2, 4031634, 1, 4031635, 1, 4031636, 1, 4031637, 2, 4031638, 2, 4031639, 1, 4031640, 1, 4031641, 2, 4031642, 2, 4031643, 1, 4031644, 1, 4031645, 2, 4031646, 2, 4031647, 1, 4031648, 1, 4031629, 1, 2370000, 1, 2370001, 1, 2370002, 1, 2370003, 1, 2370004, 1, 2370005, 1, 2370006, 1, 2370007, 1, 2370008, 1, 2370009, 1, 2370010, 1, 2370011, 1, 2370012, 1, 2050004, 1, 2000019, 1, 2002000, 1, 2002001, 1, 2002002, 1, 2002004, 1, 2002005, 1, 2022000, 1, 2022003, 1, 4006001, 1, 5072000, 1, 5073000, 1, 5074000, 1, 5076000, 1, 2040713, 1, 2040715, 1, 2044105, 1, 2040009, 1, 2040011, 1, 2040103, 1, 2040108, 1, 2040208, 1, 2040305, 1, 2040309, 1, 2040405, 1, 2040411, 1, 2040509, 1, 2040605, 1, 2040809, 1, 2040811, 1, 2040815, 1, 2040905, 1, 2040917, 1, 2040922, 1, 2041027, 1, 2041031, 1, 2041033, 1, 2041035, 1, 2041037, 1, 2041039, 1, 2043005, 1, 2043105, 1, 2043205, 1, 2043705, 1, 2043805, 1, 2044005, 1, 2044305, 1, 2044405, 1, 2044505, 1, 2044605, 1, 2044705, 1, 4010000, 2, 4010001, 2, 4010002, 2, 4010003, 2, 4010004, 2, 4010005, 2, 4010006, 2, 4020000, 2, 4020001, 2, 4020002, 2, 4020003, 2, 4020004, 2, 4020005, 2, 4020006, 2, 4020007, 2, 4020008, 2, 2040505, 1, 2040805, 1, 2040302, 1, 2043002, 1, 2043202, 1, 2043302, 1, 2043702, 1, 2043802, 1, 2044002, 1, 2044102, 1, 2044202, 1, 2044302, 1, 2044402, 1, 2044502, 1, 2044602, 1, 2044702, 1, 2044802, 1, 2044902, 1, 2340000, 1, 2049100, 1, 4002002, 1, 4002003, 1 };
        ...
        自动掉落物品 = new int[] { 4001126, 2049100 };
        GameConstants.owlItems = new int[] { 1082002, 2070005, 2070006, 1022047, 1102041, 2044705, 2340000, 2040017, 1092030, 2040804 };
        黑龙箱子 = new int[] { 2340000, 1, 2290096, 1, 2290049, 1, 2290041, 1, 2290047, 1, 2290095, 1, 2290017, 1, 2290075, 1, 2290085, 1, 2290116, 1, 1302059, 3, 2049100, 1, 2340000, 1, 1092049, 1, 1102041, 1, 1432018, 3, 1022047, 3, 3010051, 1, 3010020, 1, 2040914, 1, 1432011, 3, 1442020, 3, 1382035, 3, 1372010, 3, 1332027, 3, 1302056, 3, 1402005, 3, 1472053, 3, 1462018, 3, 1452017, 3, 1422013, 3, 1322029, 3, 1412010, 3, 1472051, 1, 1482013, 1, 1492013, 1, 1382050, 1, 1382045, 1, 1382047, 1, 1382048, 1, 1382046, 1, 1332032, 4, 1482025, 3, 4001011, 4, 4001010, 4, 4001009, 4, 2030008, 5, 1442018, 3, 2040900, 4, 2000005, 10, 2000004, 10, 4280000, 4 };
        lBalloon = new ArrayList<Balloon>();
    }
}
