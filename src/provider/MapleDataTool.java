...
public class MapleDataTool
{
    ...
    public static long getLong(final MapleData data, final long def) {
        if (data == null || data.getData() == null) {
            return def;
        }
        if (data.getType() == MapleDataType.STRING) {
            return Long.valueOf(getString(data));
        }
        if (data.getType() == MapleDataType.SHORT) {
    ...
    public static long getLongConvert(final String path, final MapleData data) {
        final MapleData d = data.getChildByPath(path);
        if (d.getType() == MapleDataType.STRING) {
            return Long.valueOf(getString(d));
        }
        return getLong(d);
    }
    
    public static Long getLong(final String path, final MapleData data, final long def) {
