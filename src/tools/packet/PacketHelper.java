...
public class PacketHelper
{
    ...
    public static final void addCharLook(final MaplePacketLittleEndianWriter mplew, final MapleCharacter chr, final boolean mega, final boolean channelserver) {
        ...
        mplew.write(255);
        final Item cWeapon = equip.getItem((short)(-111));
    ...
    public static void addDDItemInfo(final MaplePacketLittleEndianWriter mplew, final Item item, final boolean zeroPosition, final boolean leaveOut, final boolean cs) {
    ...
    public static void addItemInfo(final MaplePacketLittleEndianWriter mplew, final Item item, final boolean zeroPosition, final boolean leaveOut) {
        addItemInfo(mplew, item, zeroPosition, leaveOut, false);
    }
    
    public static void addItemInfo(final MaplePacketLittleEndianWriter mplew, final Item item, final boolean zeroPosition, final boolean leaveOut, final boolean trade) {
    ...
    public static final void addInteraction(final MaplePacketLittleEndianWriter mplew, final IMaplePlayerShop shop) {
        ...
        mplew.writeInt(((MapleMapObject)shop).getObjectId());
